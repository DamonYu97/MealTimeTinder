...
public class HunterSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.requestMatchers().and().authorizeRequests().antMatchers("/hunter/login/**", "/hunter/meals","/hunter/tester","/hunter/getRestaurantsFromMeal/**","/hunter/createNewHunterAccount/**","/hunter/getRecipesForMeal/**","/hunter/getSpecificMeal/**").permitAll();
